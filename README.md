...
- **Résultats des matchs** récupérés via deux proxys du Worker (voir [worker.js](#architecture--cloudflare-worker)) : `/api/leaguepedia` (cargoquery MatchSchedule de lol.fandom.com) et `/api/lolesports` (API persisted lolesports), cache 120 s côté Worker.
